...
public class CargadorDatos {
  ...
  public void cargarDatos() throws Exception {
    ...
    //Localidad once = GeoRefAPIService.getInstancia().localidadPorNombreYProv("Once",caba.id).localidades.get(0);
    //Localidad congreso = GeoRefAPIService.getInstancia().localidadPorNombreYProv("Congreso",caba.id).localidades.get(0);
